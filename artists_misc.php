...
/// do nothing
 ...
 ?>
<div id="trail"><a href="index.php" class="trail">Home</a> &gt; <a href="artists.php" class="trail">Artists</a> &gt; Misc </div>


<h1>Artists: Miscellaneous Works</h1>
...
$query = "SELECT art.art_registered, art.art_hide, art.art_misc
...
for($i = 0; $i<$num_elements; $i++) {
    ...
    if( $compare_name==0 ) {
       echo "<dt>" . "<a href=\"artwork.php?art_id=$row[0]&browseby=Misc\">";
