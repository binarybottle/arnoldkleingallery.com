...
function searchForm3()
{
  ...
  $searchwords_artist = (isset($_GET['words_artist']) ? htmlspecialchars(stripslashes($_REQUEST['words_artist'])) : '');
  ...
  echo '<br /><br /><b>OR</b>&nbsp;&nbsp;<font size=/"2/"><i>Search by artist\'s last name: <input type="text" size="35" name="words_artist" value="'.$searchwords_artist.'" />';
  ...
  echo '<br /><br />';
  echo '<b>AND</b> optional Art ID# Start: <input type="text" size="6" name="start" value="'.$range_start.'" /> ';
