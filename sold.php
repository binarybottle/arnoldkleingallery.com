...
/// do nothing
 ...
 ?>
<div id="trail"><a href="index.php" class="trail">Home</a> &gt; <a href="sections.php?section=<?php print "$section"; ?>" class="trail"><?php print "$section"; ?></a> &gt; Sold </div>
...
$num_columns  = 4;
$num_rows     = round($num_elements/$num_columns);
?>
...
for($i = 0; $i<$num_elements; $i++) {
    ...
    if( $compare_name==0 ) {
       echo "<dt>" . "<a href=\"art.php?art_id=$row[0]&browseby=Sold\">";
